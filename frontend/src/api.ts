...
export type Row = { id: string; version: number; vendorId: string; vendorName: string; ownerId: string; name: string; category: string; status: string; billingPeriod: string; amount: string; startDate: string; endDate: string; renewalDate: string | null };
